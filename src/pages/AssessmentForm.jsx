    ...
    <div style={{ minHeight: '100vh', background: '#faf9f7', fontFamily: "'Inter', system-ui, sans-serif", paddingBottom: 80 }}>
      ...
      <div style={{ maxWidth: 1400, margin: '0 auto', padding: 'clamp(16px, 4vw, 48px)', paddingTop: 24, paddingBottom: 0 }}>
        ...
        <div style={{ marginBottom: 14 }}>
          {type==='drugfever'    && <DrugFeverAssessment    onAnalysisComplete={setAnalysisResult} initialData={location.state?.caseData} pharmacistNote={pharmacistNote} setPharmacistNote={handlePharmacistNoteChange} />}
          ...
          {type==='heme'         && <HemeAssessment         onAnalysisComplete={setAnalysisResult} pharmacistNote={pharmacistNote} setPharmacistNote={handlePharmacistNoteChange} />}
